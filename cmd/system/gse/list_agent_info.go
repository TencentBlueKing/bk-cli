...
func newListAgentInfoCmd(deps systemcmd.BuildDeps) *cobra.Command {
	return newAgentListCommand(agentListCommandSpec{
		Name:  "list_agent_info",
		Short: "Query agent details for a list of agent IDs",
		Example: utils.FormatCommandExamples(
			...
			"bk-cli gse list_agent_info --body '{\"agent_id_list\":[\"02000000000000000000000000000001\"]}'",
		),
		Path: "/api/v2/cluster/list_agent_info",
	}, deps)
}
