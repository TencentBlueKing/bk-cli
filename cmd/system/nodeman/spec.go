...
// Package nodeman implements the Node Management system command and its Go-implemented actions.
package nodeman
...
// NewSystemSpec returns the top-level nodeman system spec used during command registration.
func NewSystemSpec() systemcmd.SystemSpec {
	return systemcmd.SystemSpec{
		Name:        "nodeman",
		Description: "BlueKing Node Management commands",
