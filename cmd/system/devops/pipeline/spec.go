...
// Package pipeline defines the DevOps pipeline subsystem commands.
package pipeline
...
// NewSystemSpec returns the pipeline subsystem spec used during command registration.
func NewSystemSpec() systemcmd.SystemSpec {
	return systemcmd.SystemSpec{
		Name:        "pipeline",
		Description: "BlueKing DevOps pipeline commands",
